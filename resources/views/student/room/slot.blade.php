...
<select name="time" class="w-[70%] rounded-xl text-gray-200 dark:bg-gray-700  shadow-lg border-none p-3 px-4 mb-3"
    id="">
...
<style>
    * {
        scrollbar-color: #565c5b #0e0f0f;
        scrollbar-width: 8px;
    }
</style>


<div id="slot-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full dark">
    ...
    <div class="relative p-4 w-full max-w-3xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-[#11151f]">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" onclick="close_model()"
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    data-modal-toggle="slot-modal">
            ...
            <div class="p-4 md:p-5 flex justify-center items-center flex-col">
                <div class="flex flex-col w-full">
                    <div class="flex flex-col gap-4 w-full">
                        <div class="flex flex-col">
                            ...
                            <input
                                class="mt-3 w-[70%] rounded-xl text-gray-200 dark:bg-gray-700  shadow-lg border-none p-3 px-4 mb-3 text-sm"
                                oninput='getAvailableTime(this)' id="model_date" type="date" min="{{date('Y-m-d')}}">
                        </div>

                        <div id="container_btn" class="m-0  hidden">
                            <button id="graph_btn"
                                class="shadow-sm rounded-xl text-sm text-white bg-gray-700 p-2 px-3 cursor-pointer hover:bg-gray-900"><i
                                    class="fa-regular fa-calendar-check fa-sm"></i></button>
                        </div>

                        <div class="hidden" id="loader">
                            @include('student.partials.small_loader')
                        </div>


                        <div class="flex flex-col hidden" style="overflow-x: auto; width: 100%;"
                            id="calender_container">
                            <div id="calender"></div>
                        </div>


                        <div class="flex flex-col " id="timeContainer">
                            <label for="" class="text-white text-sm mb-4 w-full text-start">Select available time
                                slot</label>
                            <div class='overflow-y-auto w-full flex justify-center flex-col items-start'
                                style="scrollbar-color: #565c5b #0e0f0f">
                                <div class="max-w-[200px] flex flex-row gap-4 mt-4 hidden" id='timeSlotContainer'>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id="" data-slot-id='8'>8.00 a.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='9'>9.00 a.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='10'>10.00 a.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='11'>11.00 a.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='12'>12.00 p.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='13'>1.00 p.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='14'>2.00 p.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='15'>3.00 p.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='16'>4.00 p.m</a>
                                    <a class="cursor-pointer px-3 py-2 bg-sky-400 rounded-md hover:bg-sky-700 text-gray-800 text-bold text-md text-center min-w-[100px]"
                                        data-available-id='' data-slot-id='17'>5.00 p.m</a>
                                </div>
                                <div class="max-w-[200px] flex flex-row gap-4  mb-4 hidden" id="timeRoomContainer">
                                    <a class="px-3 py-2 text-teal-300 text-bold text-sm text-center min-w-[100px] invisible"
                                        data-room-id='8'></a>
                                    <a class="px-3 py-2 text-teal-300 text-bold text-sm text-center min-w-[100px] invisible"
                                        data-room-id='9'></a>
                                    <a class="px-3 py-2 text-teal-300 text-bold text-sm text-center min-w-[100px] invisible"
                ...
                <button type="button" onclick="data_store()" data-modal-toggle="slot-modal"
                    class="text-slate-700 inline-flex items-center mt-4  bg-teal-200 hover:bg-teal-700 focus:outline-hidden  font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-teal-200 dark:hover:bg-teal-700  mx-auto">
                    Save
                </button>
            </div>
        </div>
...
<link href="https://cdn.jsdelivr.net/npm/@event-calendar/build@4.0.1/dist/event-calendar.min.css" rel="stylesheet">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const btn_graph = document.getElementById('graph_btn');
        const time_container = document.getElementById('timeContainer');
        const calender_container = document.getElementById('calender_container');


        btn_graph.addEventListener('click', () => {
            calendarVisible = !calendarVisible;

            if (calendarVisible) {
                time_container.classList.add('hidden');
                calender_container.classList.remove('hidden');

                const date = document.getElementById('model_date').value;

                document.getElementById('loader').classList.remove('hidden');

                axios.get(`/student/api/reservation_calender_slot/{{$room->id}}/${date}`)
                    .then((response) => {
                        draw_calender(date, response.data);
                    })
                    .catch((error) => {
                        console.error(error);
                    })
                ...
                time_container.classList.remove('hidden');
                calender_container.classList.add('hidden');
            }
        });
    });
    ...
    function draw_calender(date_i, res) {
        ...
        const calendar = EventCalendar.create(calendarEl, {
            ...
            select: function (info) {
                ...
                if (start < now) {
                    alert("You can't select past time slots.");
                    calendar.unselect();
                    return;
                }
                ...
                if (durationHours > 2) {
                    alert('You can only select up to 2 time slots (2 hours max)');
                    calendar.unselect();
                    return;
                }
                ...
                const overlap = events.some(event => {
                    return (
                        ...
                        event.resourceIds[0] === info.resource.id
                    );
                });
                ...
                if (overlap) {
                    ...
                    for (let hour = startHour; hour < endHour; hour++) {
                        ...
                        selectedSlots.push({ [info.resource.id]: hour });
    ...
    async function getAvailableTime(event) {
        ...
        if (event.value) {
            document.getElementById('container_btn').classList.remove('hidden')
            timeSlotContainer.classList.remove('hidden')
            timeRoomContainer.classList.remove('hidden')
        } else {
            document.getElementById('container_btn').classList.add('hidden')
    ...
    function data_store() {
        ...
        if (calendarVisible) {
            ...
            room_id.value = JSON.stringify(selectedSlots);

            const formattedTimes = selectedSlots.map(slot => {
                const hour = Object.values(slot)[0];
                return `${hour}:00`;
            });
            ...
            console.log("Saved Room IDs & Times:", room_id.value);
            console.log("Formatted:", i_time.value);
