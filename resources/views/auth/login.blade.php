     ...
     @include('staff.message.error')
        <section class="bg-gray-50 h-full min-w-full dark:bg-gray-900">
            <div class="flex flex-col w-full items-center justify-center px-6 py-8 mx-auto h-full lg:py-0">
                ...
                <div class="w-full bg-white rounded-lg shadow-sm dark:border md:mt-0 max-w-[800px] xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="flex flex-1 flex-col space-y-4 md:space-y-6">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-start">
                                        ...
                                        <input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded-sm bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-600 dark:ring-offset-gray-800" >
                                        </div>
                                ...
                                <button type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-hidden focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
