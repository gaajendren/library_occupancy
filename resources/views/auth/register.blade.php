<x-guest-layout>
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col min-w-[500px] items-center justify-center px-6 py-8 mx-auto h-full lg:py-0">
          
            <div class="w-full bg-white rounded-lg shadow dark:border mt-16 mb-16  sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
